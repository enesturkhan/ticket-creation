...
export default function FormSection() {
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      // Gerçek bir API çağrısı olacak yerde şimdilik gecikme simulasyonu
      ...
      // Biraz gecikme ekleyerek animasyon etkisi oluştur
      setTimeout(() => {
        setSubmitted(true);
      }, 500);
    } catch (error) {
  ...
  // Form başarıyla gönderildiğinde bilet gösteriliyor
